    ...
    try {
      ...
      if (vType.equals(ViewType.TEXTVIEW)) {
        ...
        cs3500.animation.provider.view.EditorView view2 =
                new cs3500.animation.provider.view.EditorView(String.format("User's animation for %s", inFile), model);
        view2.showView();
      }
      else {
