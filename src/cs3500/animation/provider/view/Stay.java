...
public class Stay extends cs3500.animation.model.Stay implements IMotion {
  /**
   ...
   */
  public Stay(int startTick, int endTick, List<Integer> startPoint, List<Integer> endPoint, RGBColor startColor, RGBColor endColor, int startWidth, int startHeight, int endWidth, int endHeight) {
