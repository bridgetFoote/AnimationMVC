...
/**
 * Represents our provider's implementation of an Ellipse.
 */
public class Ellipse extends SWKFToIShapeAdapter implements IShape {
   ...
   */
  public Ellipse(String name, ShapeType type, Posn p, double w, double h, IColor c) {
