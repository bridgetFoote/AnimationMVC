...
public class ShapeActionToIMotionAdapter extends ShapeAction implements IMotion {
   ...
   */
  public ShapeActionToIMotionAdapter(int startTick, int endTick, List<Integer> startPoint, List<Integer> endPoint, RGBColor startColor, RGBColor endColor, int startWidth, int startHeight, int endWidth, int endHeight) {
